      ...
      <div className="container mx-auto px-4 md:px-8">
        <div className="grid lg:grid-cols-2 gap-14 items-center">
          ...
          >
            ...
            <Link
              href="/about"
              className="inline-flex items-center gap-2 px-8 py-4 bg-brand text-[#0a0a0a] font-bold rounded-xl hover:bg-brand-light hover:shadow-glow-brand transition-all duration-300"
            >
          ...
          >
            ...
            <div className="absolute -bottom-6 -right-6 bg-brand rounded-2xl p-6 shadow-luxury-lg text-[#0a0a0a]">
